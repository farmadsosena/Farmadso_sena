...
<body>
    ...
    <div class="popup">
        <form class="form" method="post">
            ...
            <a class="volv" href="login.php" style="text-decoration: none; font-size: 16px;">Volver</a>
        </form>
    </div>
    <?php
    ...
    if (isset($_POST['validar'])) {
        ...
        require_once '../controllers/consultarUsuarioCorreo.php';
        ...
        if ($id != null) {
            ...
            ?>
            <script>
                window.location.href = "../controllers/codigoRecuperacion.php?email=<?php echo $token; ?>";
            </script>
            <?php
