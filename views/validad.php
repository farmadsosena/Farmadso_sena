      ...
      <form method="post">
        <article>
          <section>
            ...
            <input type="text" name="clave" id="" placeholder="Introduce aquí el código recibido" />
          </section>
        ...
        <button name="claveEscrita">Verifica el código y <span>
            <h2>accede</h2>
          </span></button>
      </form>
    </article>
